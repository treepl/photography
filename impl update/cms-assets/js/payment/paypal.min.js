...
createOrder:function(a,c){a={amount:b.querySelector("input[name='Payment_Amount']").value,PaymentType:"CreditCard",CustomerEmail:b.querySelector("input[name='Email']").value};return fetch(`/public/api/paypal/orders/${m(b.action,"form")}`,{method:"post",headers:{"content-type":"application/json"},body:JSON.stringify(a)}).then(function(a){return a.json()}).then(function(a){return a.Id})},fields:{number:{selector:`#card-number_${h}`,placeholder:"card number"},cvv:{selector:`#cvv_${h}`,placeholder:"CVV"},
expirationDate:{selector:`#expiration-date_${h}`,placeholder:"MM/YYYY"}},onError:function(a){alert(a)}}).then(function(a){b.addEventListener(k,function(c){c.preventDefault();c=c.target;"true"!==c.dataset.form_submitted?(b.CMS_AfterFormPaymentHandled=new Event("CMS_AfterFormPaymentHandled",{cancelable:!0}),c.CMS_CustomSubmit||(b.CMS_CustomSubmit=new Event("CMS_CustomSubmit",{cancelable:!0})),c.dataset.form_submitted=!0,b.CMS_CustomSubmit.data={form:b,hostedFields:a},e(b.CMS_CustomSubmit.data,function(){b.dispatchEvent(b.CMS_CustomSubmit)})):
alert("Form submission is in progress.")})});d(g,b.elements.Payment_Type.value,h);b.elements.Payment_Type.onchange=function(a){a.preventDefault();d(g,a.target.value,b.name)};b.addEventListener("CMS_CustomSubmit",function(a){a.defaultPrevented?a.data.form.dataset.form_submitted=!1:e(a.data)});b.addEventListener("CMS_triggerHandlePayment",function(a){if(a.data.response&&a.data.response.FormRedirectLink&&""!==a.data.response.FormRedirectLink){let c="SuccessPage";"Paypal"===b.elements.Payment_Type.value&&
(c="PaymentRedirect");b.CMS_AfterFormPaymentHandled.data={FormRedirectLink:a.data.response.FormRedirectLink,LinkType:c,Response:a.data.response};a.data.submitData.form.dispatchEvent(a.data.submitData.form.CMS_AfterFormPaymentHandled)}else e(a.data.submitData)});b.addEventListener("CMS_AfterFormPaymentHandled",function(a){a.defaultPrevented||(window.location=a.data.FormRedirectLink)})})}function m(d,e){d=new URL(d);return(new URLSearchParams(d.search)).get(e)}function n(d){d=new URL(d);d=new URLSearchParams(d.search);
let e=0;for(let k of d)e++;return e}document.addEventListener("DOMContentLoaded",function(d){setTimeout(()=>{l()},0)})})();
